 ...
 *
 * v6 — Template ESP32-S3 per a Arduino IDE
 * Funcionalitats: WiFi multi-xarxa · MQTT · Neopixel · Temperatura interna + DS18B20 · NTP · LWT
...
#define TOPIC_ONLINE    TOPIC_BASE "/online"    // LWT: "1" = en línia, "0" = fora de línia (retained)
...
//   /esp32s3/alumneXX/online         → "1" quan el dispositiu és en línia, "0" (LWT) si cau
// ============================================================
...
void mainTask(void* param) {
  ...
  mqtt.onConnect([]() {
    ...
    mqtt.publish(TOPIC_ONLINE, "1", true);  // marca el dispositiu com a en línia (retained)
  ...
  // LWT: si el dispositiu cau sense desconnectar-se correctament, el broker
  // publica "0" retained a TOPIC_ONLINE automàticament.
