# 📦 Activitat 00: Instal·la Hermes Agent

Abans de començar a xatejar amb Hermes, l'has d'instal·lar! Tens **dos camins**:

---

## 🖥️ [00a — Instal·lació local](./00a-instalacio-local/README.md)

Per instal·lar Hermes al teu **ordinador personal** (Windows, Mac o Linux).
> ✅ Ideal per començar de seguida
> ✅ No cal pagar res extra
> ✅ Pots fer les activitats 01–05 al teu PC

## ☁️ [00b — Instal·lació en VPS](./00b-instalacio-vps/README.md)

Per tenir un Hermes **24/7 al núvol**, accessible des de qualsevol lloc.
> ✅ Per connectar Telegram / Discord
